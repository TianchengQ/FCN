...
from Segmentation import dataset_util
import cv2
import numpy as np
...
flags = tf.app.flags
flags.DEFINE_string('data_dir', '/Users/chin/Downloads/VOCdevkit/VOC2012', 'Root directory to raw pet dataset.')
flags.DEFINE_string('output_dir', '/Users/chin/Desktop/week10/output', 'Path to directory to output TFRecords.')
...
def dict_to_tf_example(data, label):
    ...
    if height < vgg.vgg_16.default_image_size or width < vgg.vgg_16.default_image_size:
        # 保证最后随机裁剪的尺寸
        return None
...
def create_tf_record(output_filename, file_pars):
    ...
    with contextlib2.ExitStack() as tf_record_close_stack:
        ...
        for idx, fl in enumerate(file_pars):
            lbl = fl[1]
            img = fl[0]
            tf_example = dict_to_tf_example(img, lbl)
